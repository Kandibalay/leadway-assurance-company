  ...
  return (
    <div className='hero '>
        ...
        <div className=' flex flex-col lg:flex-row gap-4 mt-8 w-full md:w-1/2 lg:w-[25%] xl:w-[20%] '>
            <button type="button" className='bg-[#EC5B0C] hover:bg-orange-700 rounded-md mx-auto lg:mx-0 py-3 w-1/2 font-semibold transition-transform transform hover:scale-110'>Get Quote</button>
