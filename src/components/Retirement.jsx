  ...
  return (
    <div className="flex flex-col gap-[55px] py-10">
      ...
      <div className="flex gap-2  items-start">
        <img src={icons} alt="" className="pt-1.5" />
        <div>
          <h2 className="text-[18px] font-semibold">Easy Access Anytime</h2>
          <p className="text-base">
      ...
      <div className="flex justify-center lg:justify-start">
        <button className="text-white bg-orange-600 rounded-lg w-63 py-3 text-[18px] font-semibold button-1">Start Your Retirement Plans</button>
      </div>
      </div>
    </div>
    </div>
