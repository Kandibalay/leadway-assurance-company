...
const Insurance = () => {
  return (
    <div className='w-full container mx-auto lg:w-[70%] mx-auto my-10'>
        <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4'>
            ...
            <div key={item.id} className='bg-[#FDEFE7] shadow-lg rounded-lg p-6 flex flex-col items-start'>
                ...
                <a href="#" type="button" className='mt-4 text-[#EA5B0C] rounded-md py-2 font-semibold underline'>View Details</a>
            </div>
            ))}
        </div>
    </div>
