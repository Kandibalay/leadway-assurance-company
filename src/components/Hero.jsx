...
const Hero = () => {
  return (
    <div className='hero'>
        <div className='w-full h-[500px] container mx-auto flex flex-col items-center justify-center gap-3'>
        ...
        <div className=' flex flex-col lg:flex-row gap-4 mt-8 w-full lg:w-[25%] xl:w-[20%] '>
