  ...
  return (
    <div className='shadow fixed z-50 right-0 left-0 w-full'>
      ...
      <div className='bg-white text-black shadow-sm'>
        <div className='px-6 md:px-10 lg:px-14 container mx-auto flex justify-between items-center py-2'>
              ...
              {activeDropdown === 'insurance' && (
                <div className='absolute -left-30 mt-4 w-240 rounded-xl bg-white shadow-lg z-50 text-black px-14 pt-10 pb-16'>
                  <div className='py-2 grid grid-cols-3 gap-4'>
                   ...
                   <a href='#' className='block text-[16px] font-medium  hover:text-[#EA5B0C] transition-colors duration-200'>
                      Business Insurance
                    </a>
                    <ul className='flex flex-col gap-3 text-[14px]'>
                      <li><a href="#" className='cursor-not-allowed'>Marine Insurance</a></li>
                      <li><a href="#" className='cursor-not-allowed'>SME Insurance</a></li>
                      <li><a href="#" className='cursor-not-allowed'>Property Insurance</a></li>
                      <li><a href="#" className='cursor-not-allowed'>Accident Policies</a></li>
                    </ul>
                   </div>
                   <div className='flex flex-col gap-5'>
                   <a href='#' className='block text-[16px] font-medium  hover:text-[#EA5B0C] transition-colors duration-200'>
                    ...
                    <ul className='flex flex-col gap-3 text-[14px]'>
                      <li><a href="#" className='cursor-not-allowed'>General Insurance</a></li>
                      <li><a href="#" className='cursor-not-allowed'>Savings & Investment</a></li>
                      <li><a href="#" className='cursor-not-allowed'>Travel Insurance</a></li>
                      <li><a href="#" className='cursor-not-allowed'>Health & Life</a></li>
                      <li><a href="#" className='cursor-not-allowed'>Annuities & Pension</a></li>
                      <li><a href="#" className='cursor-not-allowed'>Property Insurance</a></li>
                    </ul>
                   </div>
                   <div className='flex flex-col gap-5'>
                   <a href='#' className='block text-[16px] font-medium  hover:text-[#EA5B0C] transition-colors duration-200'>
                    ...
                    <ul className='flex flex-col gap-3 text-[14px]'>
                      <li><a href="#" className='cursor-not-allowed'>Comprehensive</a></li>
                      <li><a href="#" className='cursor-not-allowed'>Third Party</a></li>
                      <li><a href="#" className='cursor-not-allowed'>Third Party(Auto Base)</a></li>
                      <li><a href="#" className='cursor-not-allowed'>Third Party(Scratch Card)</a></li>
                    </ul>
                   </div>
         ...
         <button className='hidden w-1/2 lg:block bg-[#EA5B0C] hover:bg-orange-700 text-white rounded-lg py-2 font-medium transition-transform transform hover:scale-110 duration-200'>
            Sign up
          </button>
         <button className='hidden w-1/2 lg:block border border-[#EA5B0C] text-[#EA5B0C] rounded-lg py-2 font-medium duration-200 transition-transform transform hover:scale-110'>
              Login
          </button>
         </div>
        ...
        <div className="lg:hidden fixed inset-0 bg-black/50 z-50 flex justify-end ">
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center px-4 pb-1 space-y-2 overflow-y-auto">
              {/* Home */}
              <div className="pb-1 ">
                <a href="#" className="block text-black text-base font-medium  hover:text-[#EA5B0C] py-2 transition-colors duration-200">
                  Home
                </a>
              </div>
              ...
              <div className="pb-1 ">
                ...
                {activeDropdown === 'insurance' && (
                  <div className="mt-2 space-y-2 pl-4 transform transition-all duration-300 ease-in-out">
                   ...
                   <div className='flex flex-col gap-5'>
                        <div>
                          <div onClick={() => toggleDropdownMenu('business')}
                              className='flex justify-between items-center cursor-pointer'>
                              <span><a href='#' className='block text-[16px] font-medium  hover:text-[#EA5B0C] transition-colors duration-200'>
                                  Business Insurance
                              </a></span>
                                <RiArrowDropDownLine 
                                className={`h-6 w-6 transition-transform duration-200 ${
                   ...
                   <div className='flex flex-col gap-5'>
                        <div>
                          <div onClick={() => toggleDropdownMenu('personal')}
                            className='flex justify-between items-center cursor-pointer'>
                              <span><a href='#' className='block text-[16px] font-medium  hover:text-[#EA5B0C] transition-colors duration-200'>
                      Personal Insurance
                    </a></span>
                   ...
                   <div className='flex flex-col gap-5'>
                        <div>
                          <div onClick={() => toggleDropdownMenu('auto')}
                            className='flex justify-between items-center cursor-pointer'>
                              <span> <a href='#' className='block text-[16px] font-medium  hover:text-[#EA5B0C] transition-colors duration-200'>
                      Auto Insurance
                    </a></span>
              ...
              <div className='flex flex-col mx-auto gap-3 w-1/2'>
                <button className=' lg:hidden bg-[#EA5B0C] hover:bg-orange-700 text-white rounded-lg py-2 font-medium transition-transform transform hover:scale-110 duration-200'>
                    Sign up
                  </button>
                <button className=' lg:hidden border border-[#EA5B0C] text-[#EA5B0C] rounded-lg py-2 font-medium duration-200 transition-transform transform hover:scale-110'>
                      Login
                  </button>
              </div>
            </div>
