  ...
  return (
    <div className='text-black py-12 px-6 md:px-10 lg:px-14 container mx-auto'>
      <div className='flex flex-col justify-center items-center gap-4 p-6'>
        ...
        <p className='font-light text-[14px] lg:text-[16px] lg:w-[85%] text-center'>Reliable, tailored protection for your cargo against loss or damage during transit by sea, air, or land — whether importing, exporting, or moving locally.</p>
      </div>

      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mx-auto lg:py-3'>
        <div className='border border-[#F6BC9B] rounded-lg py-5 px-4'>
          <img src={img1} alt="" className='w-8 h-8'/>
          <h3 className='font-semibold text-[18px] mt-2.5 '>All-Risk Coverage for
            Goods in Transit</h3>
        ...
        <div className='border border-[#F6BC9B] rounded-lg py-5 px-4'>
          ...
          <h3 className='font-semibold text-[18px] mt-2.5 '>General Average and
            Salvage Charges</h3>
        ...
        <div className='border border-[#F6BC9B] rounded-lg py-5 px-4'>
          ...
          <h3 className='font-semibold text-[18px] mt-2.5 '>Warehouse-to-Warehouse
            Coverage</h3>
        ...
        <div className='border border-[#F6BC9B] rounded-lg py-5 px-4'>
          ...
          <h3 className='font-semibold text-[18px] mt-2.5 '>Theft, Piracy & Accidental
            Loss Protection</h3>
        ...
        <div className='border border-[#F6BC9B] rounded-lg py-5 px-4'>
          ...
          <h3 className='font-semibold text-[18px] mt-2.5 '>Flexible and Customizable Policy Options</h3>
        ...
        <div className='border border-[#F6BC9B] rounded-lg py-5 px-4'>
          ...
          <h3 className='font-semibold text-[18px] mt-2.5 '>Prompt and Transparent Claims Processing</h3>
