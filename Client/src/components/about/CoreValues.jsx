...
const CoreValues = () => {
  return (
    <div className="text-[#5A5A5A] px-6 mx:px-10 lg:px-14 py-10 container mx-auto">
      ...
      <p className="text-center text-[14px] w-[80%] lg:w-[70%] mx-auto lg:text-[14px] text-black mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div
                key={value.id}
                className="bg-[#FDEFE7] shadow-lg p-5 rounded-lg"
            >
                <img src={value.icon} alt={value.title} className="flex items-start w-10 h-10" />
                <h3 className="text-left font-semibold text-[18px] mb-2">
                {value.title}
                </h3>
