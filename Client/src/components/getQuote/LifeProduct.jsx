...
const cardData = [
  {
    ...
    description: "Provides financial support to your loved ones in the event of life’s uncertainties, helping them stay secure.",
    image: one,
  },
  {
...
const LifeProduct = () => {
  ...
  return (
    ...
    <>
    <div className="text-black flex-items-center py-10 px-4 container mx-auto" >
