...
const Hero = () => {
  return (
    <div className='hero '>
        ...
        <h1 className='text-[40px] w-[95%] lg:w-full font-semibold lg:text-[50px] leading-[1.2] lg:leading-none'>Insurance that puts you first.</h1>
        <p className='text-[18px] w-[80%] lg:w-full lg:text-[25px] font-medium'>Confidence in every claim. Support at every step.</p>
        <div className=' flex flex-col lg:flex-row gap-4 mt-8 w-full md:w-1/2 lg:w-[25%] xl:w-[23%] '>
