...
// export default function MarineQuoteModal({ onClose, onSubmit }) {
...
//         <h2 className="font-bold text-xl">Request a Marine Cargo Insurance Quote</h2>
//         <p className="text-center font-thin">Get tailored protection for your cargo in just a few steps. Fill in your details and a representative will reach out shortly.</p>
//       </div>
//       <form >
//         <div>
...
//         </div>
//         <div>
//             <label className="block mb-2 text-sm font-medium text-gray-700">Company Name <span className='text-sm text-gray-300 font-light'>(optional)</span></label>
//             <input
//                 type="text"
...
//         <button type="submit" className="bg-[#18A532] text-white py-2 w-full rounded-md">
//           Submit
//         </button>
//       </form>
//     </div>
