...
const Achievement = () => (
  <div className='text-black py-4  md:px-10 lg:px-14 gap-12 bg-[#EBEBEB]'>
    <div className='grid grid-cols-1 lg:grid-cols-4 container  gap-4 mx-auto py-2'>
      <div className=' border-b lg:border-b-0 lg:border-r border-b-[#969696] lg:border-[#969696] py-8 px-7  text-center'>
        ...
        <div className='mt-7'>
          ...
          <p className='text-[18px] '>Marine Coverage</p>
        </div>
      </div>
      <div className='border-b lg:border-b-0 lg:border-r border-b-[#969696] lg:border-[#969696] py-8 px-7  text-center'>
        <div className='flex justify-center'>
        ...
        <div className='mt-7'>
          ...
          <p className='text-[18px] '>for Every Shipment</p>
        </div>
      </div>
      <div className='border-b lg:border-b-0 lg:border-r border-b-[#969696] lg:border-[#969696] py-8 px-7  text-center'>
        <div className='flex justify-center'>
