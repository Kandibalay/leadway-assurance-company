          ...
          <div className="w-full">
            ...
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center">
                <input
                  {...register("remember")}
                  className="w-3 lg:w-4 cursor-pointer h-3 lg:h-4"
                  type="checkbox"
                  id="remember"
                />
                <label
                  htmlFor="remember"
                  className="ml-2 text-[12px] lg:text-[14px] text-[#222222]"
                >
                  Remember me
                </label>
              </div>
              <NavLink
                ...
                className="underline text-[#222222] text-[12px] lg:text-[14px]"
              >
                Forgot Password
              </NavLink>
            </div>
            ...
            <button
              type="submit"
              className="bg-[#EA5B0C] w-full text-white py-2 md:py-3 mt-4 rounded-lg text-[14px] hover:scale-105 transition-transform"
            >
              Sign In
            </button>
            ...
            <div className="text-center mt-4">
              <p className="text-[#969696] text-[12px] mt-4">
                ...
                <NavLink
                  to="/auth/signup"
                  className="text-[#EA5B0C] font-semibold"
                >
                  Sign Up
                </NavLink>
              </p>
